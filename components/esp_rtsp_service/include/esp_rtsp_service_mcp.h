...
/**
 * @brief  Get the MCP tool-description JSON for esp_rtsp_service
 *
...
/**
 * @brief  Invoke an esp_rtsp_service MCP tool
 *
 * @param[in]   service      RTSP service as an esp_service_t base pointer
 ...
 *       - Other                  Error from the underlying RTSP API
 */
