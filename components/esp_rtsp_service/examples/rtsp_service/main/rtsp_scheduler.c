                                      ...
                                      void *ctx)
{
    ...
    if (SERVICE_NAME_STARTS_WITH(request, ESP_RTSP_SERVICE_NAME) ||
        ESP_SERVICE_SCHEDULER_THREAD_NAME_IS(request, ESP_RTSP_SCHED_PUSH_TASK) ||
        ESP_SERVICE_SCHEDULER_THREAD_NAME_IS(request, ESP_RTSP_SCHED_SRC_TASK) ||
        ESP_SERVICE_SCHEDULER_THREAD_NAME_IS(request, ESP_RTSP_SCHED_SERVER_TASK)) {
...
esp_err_t rtsp_scheduler_install(void)
{
