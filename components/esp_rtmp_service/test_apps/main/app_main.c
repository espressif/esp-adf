...
#define MAX_LEAK_TRACE_RECORDS      1024
#define TEST_MEMORY_LEAK_THRESHOLD  40960
#define TAG                         "RTMP_MAIN"

extern void esp_rtmp_service_ut_force_link(void);
...
void app_main(void)
{
    ...
    esp_rtmp_service_ut_force_link();
    init_softap();

    printf("Running esp_rtmp_service unit tests\n");
    UNITY_BEGIN();
