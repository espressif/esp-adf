...
/**
 * @brief  Get the MCP tool-description JSON for esp_rtmp_service
 *
...
/**
 * @brief  Invoke an esp_rtmp_service MCP tool
 *
 * @param[in]   service      RTMP service as an esp_service_t base pointer
 ...
 *       - Other                  Error from the underlying RTMP API
 */
