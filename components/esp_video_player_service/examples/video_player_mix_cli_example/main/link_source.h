...
/**
 * @brief  Link a dummy SRC onto stream 0 and start it
 *
 *         Refer to `link_source.c` for this path. The dummy SRC is a bouncing-ball
 *         H264 + AAC clip; swap it for capture or your own SRC without changing
 *         the `esp_media_service_link` / start / unlink calls.
 *
 * @return
 *       - ESP_OK                 On success
