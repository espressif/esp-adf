# Modified from https://github.com/espressif/esp-idf/blob/b4c4e3a79d3029501bf91dca90f484cfb6951200/tools/ci/python_packages/gitlab_api.py
import argparse
import os
import re
import tarfile
...
def remove_BOM(config_path):   # remove BOM field
