...
void app_main(void)
{
    ...
    audio_element_handle_t tcp_stream_reader, mp3_decoder, i2s_stream_writer;
    ...
    ESP_LOGI(TAG, "[2.4] Link it together tcp-->mp3-->i2s");
    audio_pipeline_link(pipeline, (const char *[]) {"tcp", "mp3", "i2s"}, 3);
