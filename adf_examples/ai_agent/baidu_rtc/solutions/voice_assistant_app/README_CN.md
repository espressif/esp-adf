...
- 本例程默认使用 `esp32_s3_korvo_2_3` 开发板，硬件参考相关[文档](https://docs.espressif.com/projects/esp-adf/en/latest/design-guide/dev-boards/user-guide-esp32-s3-korvo-2.html)。
...
```bash
cd adf_examples/ai_agent/baidu_rtc/solutions/voice_assistant_app
```
