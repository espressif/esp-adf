...
- [ ] I have read the documentation [Espressif Audio Development Framework Guide](https://docs.espressif.com/projects/esp-adf/en/release-v2.x/index.html) and the issue is not addressed there.
