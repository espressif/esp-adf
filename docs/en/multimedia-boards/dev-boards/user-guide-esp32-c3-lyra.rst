...
Application examples for this board can be found at :project:`application example <adf_examples>`.
...
#. (Optional) Connect the LED strip to the development board through the **Addressable LED Strip Port** or the **RGB LED Strip Port** depending on the type of your LED strip.
