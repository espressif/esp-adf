...
The ESP-ADF comes complete with :doc:`wakeup word libraries <wakeup-word-libs>` and :doc:`speech recognition interface <esp_wn_iface>` to recognize voice wakeup commands. Most of currently implemented wakeup commands are in Chinese with one command "Alexa" in English. 
