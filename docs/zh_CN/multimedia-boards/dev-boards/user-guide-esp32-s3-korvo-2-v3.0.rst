...
ESP32-S3-Korvo-2 V3.0 主板可与 LCD 扩展板 :doc:`ESP32-S3-Korvo-2-LCD <user-guide-esp32-s3-korvo-2-lcd>` 搭配使用。本文档主要介绍 ESP32-S3-Korvo-2 V3.0 主板，更多关于 LCD 扩展板的信息，请参阅 :doc:`ESP32-S3-Korvo-2-LCD 用户指南 <user-guide-esp32-s3-korvo-2-lcd>`。
