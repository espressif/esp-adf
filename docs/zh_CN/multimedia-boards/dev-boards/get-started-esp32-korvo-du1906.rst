...
.. list-table::
   ...
   * - 调试接口 (ESP_I2C Connector/DSP_I2C Connector)
     - 开发板预留了两组 I2C 调试接口，分别为 ESP_I2C Connector 和 DSP_I2C Connector，以供用户调试代码。
   * - 麦克阵列 (Mic)
...
如果已检查确认完成初始设置，请准备开发工具。前往 :doc:`../../../get-started/index` 查看以下步骤：

* :ref:`get-started-setup-esp-idf` 提供了一套 ESP32（以及 ESP32-S2）系列芯片的 C 语言开发框架；
* :ref:`get-started-get-esp-adf` 安装音频应用程序的 API；
* :ref:`get-started-set-up-env` 使开发框架获取到音频应用的 API；
* :ref:`get-started-start-project` 提供 ESP32-Korvo-DU1906 开发板的音频应用程序示例；
